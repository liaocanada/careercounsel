        ...
        <Segment placeholder>
          {total > 0 ? (
            <>
              ...
              <p>
                1. {!!Object.keys(specializations)[2] ? ((Object.keys(specializations)[2]).substring(0, 1).toUpperCase() + (Object.keys(specializations)[2]).substring(1).toLowerCase()) : <></>} ({!!Object.keys(specializations)[2] ? ((specializations[Object.keys(specializations)[2]] * 100 / total).toFixed(1)) + "%" : "N/A"}) <br />
                ...
                3. {!!Object.keys(specializations)[0] ? ((Object.keys(specializations)[0]).substring(0, 1).toUpperCase() + (Object.keys(specializations)[0]).substring(1).toLowerCase()) : <></>} ({!!Object.keys(specializations)[0] ? ((specializations[Object.keys(specializations)[0]] * 100 / total).toFixed(1)) + "%" : "N/A"})
              </p>
            </>
          ) : (
            <>
